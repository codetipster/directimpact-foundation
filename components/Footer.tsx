          ...
          <div className="md:col-span-4 lg:col-span-5">
            <Link href="/" className="flex items-center gap-2 mb-4">
              <Image
                ...
                className="w-40 h-40"
              />
              <span className="text-xl font-semibold text-[#59B7E7]">
                DirectImpact Empowerment Foundation
              </span>
            </Link>
            <p className="text-gray-600 mb-6">
              Direct Impact Empowerment Foundation is a nonprofit organization in Nigeria 
              dedicated to reducing multidimensional poverty across Nigeria and Sub-Saharan 
              Africa by empowering youth through targeted skills acquisition and training 
              to foster economic independence and community transformation.
            </p>
          ...
          <div className="md:col-span-4 lg:col-span-3">
            ...
            <nav className="flex flex-col gap-3">
              {navigationLinks.map((link) => (
                ...
                >
                  <span className="w-1.5 h-1.5 rounded-full bg-[#B5D858] opacity-0 transition-opacity 
          ...
          <div className="md:col-span-4 lg:col-span-4">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 group">
                <div className="w-10 h-10 rounded-full bg-[#59B7E7]/10 flex items-center justify-center 
