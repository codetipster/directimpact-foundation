      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden h-full">
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex-1 p-6 flex flex-col">
                    ...
                    <p className="text-sm italic text-gray-500 mb-3">"No one should be left behind in their time of need."</p>
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden h-full">
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex-1 p-6 flex flex-col">
                    ...
                    <p className="text-sm italic text-gray-500 mb-3">"Every life we touch must feel valued."</p>
                    <p className="text-gray-600 text-sm flex-1">
          ...
          <div className="bg-gradient-to-r from-[#59B7E7]/10 to-[#B5D858]/10 p-8 rounded-lg text-center">
            ...
            <p className="text-sm italic text-gray-500 mb-4">"Vision, compassion, and action — one life at a time."</p>
